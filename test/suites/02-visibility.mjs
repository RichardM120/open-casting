...
check("A does not see the seeded demo casting calls", (await a.p.locator("main").getByText("Saltmarsh").count()) === 0);
...
check("admin sees the seeded demo casting calls too", (await ad.p.locator("main").getByText("Saltmarsh").count()) > 0);
