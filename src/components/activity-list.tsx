...
const SHAPE: Record<Action, { verb: string; tone: string }> = {
  ...
  "production_company.created": { verb: "added a production company", tone: "bg-positive" },
  "production_company.edited": { verb: "edited a production company", tone: "bg-accent" },
  "production_company.removed": { verb: "removed a production company", tone: "bg-danger" },
